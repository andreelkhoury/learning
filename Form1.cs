...
//		Microsoft.Office.Interop.Excel.ApplicationClass ExcelApp = new Microsoft.Office.Interop.Excel.ApplicationClass();
		...
		string GradeCode = ""; // "Grade Code"; // optional
        string GradeDesc = ""; // "Grade Description"; //optional
		string BranchCode = ""; //"Branch Code"; // optional
		string BranchDesc = ""; //"Branch Description"; // optional
		string CustomCr3 = ""; // "CustomCr3"; // optional
		string CustomCr4 = ""; // "CustomCr4"; // optional
        ...
        string IncomePayItemValue3 = "Income PayItem Value3";
        string IncomePayItemValue4 = "Income PayItem Value4";
...
//				}
				...
				cellvalue = (gridView3.GetRowCellValue(i, gridView3.Columns[Gender]).ToString().Trim());
...
//				}
			...
			string sqlPayItem1 = "insert into EmpRegPayTypes (EmpID, PayTypeID, CurrID, Value, PaymentFreq, Type) values (@emID1, 32, 149, @piValue1, 'EP', 'Normal')";
            string sqlPayItem2 = "insert into EmpRegPayTypes (EmpID, PayTypeID, CurrID, Value, PaymentFreq, Type) values (@emID2, 33, 149, @piValue2, 'EP', 'Normal')";
            string sqlPayItem3 = "insert into EmpRegPayTypes (EmpID, PayTypeID, CurrID, Value, PaymentFreq, Type) values (@emID3, 34, 149, @piValue3, 'EP', 'Normal')";
            string sqlPayItem4 = "insert into EmpRegPayTypes (EmpID, PayTypeID, CurrID, Value, PaymentFreq, Type) values (@emID4, 35, 149, @piValue4, 'EP', 'Normal')";
			...
			using(SqlConnection connection = new SqlConnection("user id=" + UserID + ";Password=" + Password +";data source=" + ServerName + ";persist security info=True;initial catalog=" + Database))
			{
				...
				{	
					try
					{
                        ...
                        SqlCommand cmdPayItem3 = new SqlCommand(sqlPayItem3, connection);
                        cmdPayItem3.Parameters.Add("@emID3", SqlDbType.Int);
                        cmdPayItem3.Parameters.Add("@piValue3", SqlDbType.Decimal);

                        SqlCommand cmdPayItem4 = new SqlCommand(sqlPayItem4, connection);
                        cmdPayItem4.Parameters.Add("@emID4", SqlDbType.Int);
                        cmdPayItem4.Parameters.Add("@piValue4", SqlDbType.Decimal);
                        ...
                        SqlCommand cmdGrade = new SqlCommand(sqlGrade, connection);
                        cmdGrade.Parameters.Add("@GradeDesc", SqlDbType.NVarChar);
                        cmdGrade.Parameters.Add("@GradeCode", SqlDbType.NVarChar);
...
//							command.Parameters["@Department"].Value = 4;
							...
							{
                                if (gridView3.GetRowCellValue(i, gridView3.Columns[DepDesc]).ToString().Length > 50)
                                {
                                    cmDep.Parameters["@Desc"].Value = gridView3.GetRowCellValue(i, gridView3.Columns[DepDesc]).ToString().Substring(0, 50);
                                }
                                else
                                {
                                    cmDep.Parameters["@Desc"].Value = gridView3.GetRowCellValue(i, gridView3.Columns[DepDesc]).ToString();
                                }
                                if (Convert.ToString(gridView3.GetRowCellValue(i, gridView3.Columns[DepCode])).Trim().Length > 8)
                                {
                                    cmDep.Parameters["@DepCode"].Value = Convert.ToString(gridView3.GetRowCellValue(i, gridView3.Columns[DepCode])).Trim().Substring(0, 8);
                                }
                                else
                                {
                            ...
                            if (GradeCode == "")
                            {
                                command.Parameters["@GradeID"].Value = DBNull.Value;
                            }
                            else
                            {
                                string sqlGradeID = @"SELECT [ID] FROM tbGrade WHERE Abbreviation = '" + gridView3.GetRowCellValue(i, gridView3.Columns[GradeCode]).ToString().Trim() + "'";
                                SqlCommand cmdGradeID = new SqlCommand(sqlGradeID, connection);
                                connection.Open();
                                object idGr = cmdGradeID.ExecuteScalar();
                                if (idGr == null || idGr == DBNull.Value)
                                {
                                    cmdGrade.Parameters["@GradeDesc"].Value = Convert.ToString(gridView3.GetRowCellValue(i, gridView3.Columns[GradeDesc])).Trim();
                                    cmdGrade.Parameters["@GradeCode"].Value = Convert.ToString(gridView3.GetRowCellValue(i, gridView3.Columns[GradeCode])).Trim();
                                    cmdGrade.ExecuteNonQuery();
                                    idGr = cmdGradeID.ExecuteScalar();
                                    command.Parameters["@GradeID"].Value = idGr;
                                }
                                else
                                {
                                    command.Parameters["@GradeID"].Value = idGr;
                            ...
                            if (BranchCode == "")
                            {
                                command.Parameters["@BranchID"].Value = DBNull.Value;
                            }
                            else
                            {
...
//							command.Parameters["@PositionA"].Value = 35;
							...
							{
                                command.Parameters["@DOB"].Value = Convert.ToDateTime(gridView3.GetRowCellValue(i, gridView3.Columns[DOB])).Date.ToString("yyyy-MM-dd");
							}
...
//							}
                            ...
                            try
                            {
                                command.Parameters["@ValuePerUnit"].Value = Convert.ToDecimal(gridView3.GetRowCellValue(i, gridView3.Columns[SalaryValue]));
                            }
                            catch
                            {
                                command.Parameters["@ValuePerUnit"].Value = DBNull.Value;
                            }
							if (gridView3.GetRowCellValue(i,gridView3.Columns[CyOfSalary]).ToString() == "LBP")
							{
                            ...
                            {
                                command.Parameters["@BadgeNum"].Value = DBNull.Value;
                            }
							//=============================
							//=============================
                            ...
                            command.Parameters["@HireDate"].Value = Convert.ToDateTime(gridView3.GetRowCellValue(i, gridView3.Columns[HiringDate])).Date.ToString("yyyy-MM-dd");
							//=============================
							//==============check if saved
							//=============================
							if (SpFirstName == "")
                            ...
                            if (SpDOB == "" || gridView3.GetRowCellValue(i, gridView3.Columns[SpDOB]).ToString() == "")
							{
								command.Parameters["@SpDOB"].Value = DBNull.Value;
							}
							else
							{
                                command.Parameters["@SpDOB"].Value = Convert.ToDateTime(gridView3.GetRowCellValue(i, gridView3.Columns[SpDOB])).Date.ToString("yyyy-MM-dd");
                            }
...
//							command.Parameters["@SpMoNameL"].Value = DBNull.Value;
							...
							if (TaxSince == "")
							{
                                command.Parameters["@TaxSince"].Value = Convert.ToDateTime(gridView3.GetRowCellValue(i, gridView3.Columns[HiringDate])).Date.ToString("yyyy-MM-dd");
							}
							else
							{
								...
								{
                                    command.Parameters["@TaxSince"].Value = Convert.ToDateTime(gridView3.GetRowCellValue(i, gridView3.Columns[TaxSince])).Date.ToString("yyyy-MM-dd");
								}
							}
							if (NSSFSince == "")
							{
                                command.Parameters["@HireSince"].Value = Convert.ToDateTime(gridView3.GetRowCellValue(i, gridView3.Columns[HiringDate])).Date.ToString("yyyy-MM-dd");
							}
							else
							{
								...
								{
                                    command.Parameters["@HireSince"].Value = Convert.ToDateTime(gridView3.GetRowCellValue(i, gridView3.Columns[NSSFSince])).Date.ToString("yyyy-MM-dd");
								}
							}
							//------------------------ CustomCr1
...
//							}
							...
							//======================NEW
							//======================
                            command.Parameters["@CustomCr3"].Value = DBNull.Value; // this.gridView3.GetRowCellValue(i, this.gridView3.Columns[CustomCr3]);
                            command.Parameters["@CustomCr4"].Value = DBNull.Value; // this.gridView3.GetRowCellValue(i, this.gridView3.Columns[CustomCr4]);

                            command.Parameters["@POB"].Value = DBNull.Value; // this.gridView3.GetRowCellValue(i, this.gridView3.Columns[PlaceOfBirth]);
                            command.Parameters["@PassportNum"].Value = DBNull.Value; // this.gridView3.GetRowCellValue(i, this.gridView3.Columns[PassportNb]);
                            command.Parameters["@HighCostL"].Value = DBNull.Value; // this.gridView3.GetRowCellValue(i, this.gridView3.Columns[highCostOfLiving]);
                            ...
                            command.Parameters["@ArMotherName"].Value = DBNull.Value; // this.gridView3.GetRowCellValue(i, this.gridView3.Columns[ArMotherName]);
                            command.Parameters["@ArIDNum"].Value = DBNull.Value; // this.gridView3.GetRowCellValue(i, this.gridView3.Columns[IdCardNb]);
                            command.Parameters["@ArSijilKazaa"].Value = DBNull.Value; // this.gridView3.GetRowCellValue(i, this.gridView3.Columns[ArKazaCard]);
                            command.Parameters["@ArSijilMohafaza"].Value = DBNull.Value; // this.gridView3.GetRowCellValue(i, this.gridView3.Columns[ArMohafazaCard]);
                            command.Parameters["@ArSijilPlace"].Value = DBNull.Value; // this.gridView3.GetRowCellValue(i, this.gridView3.Columns[ArRegisterPlace]);

                            command.Parameters["@SpIDNum"].Value = DBNull.Value; // this.gridView3.GetRowCellValue(i, this.gridView3.Columns[SpIdCardNb]);
                            command.Parameters["@ArSijilNum"].Value = DBNull.Value; // this.gridView3.GetRowCellValue(i, this.gridView3.Columns[SpRegisterNb]);
                            command.Parameters["@ArNationalityRegisterP"].Value = DBNull.Value; // this.gridView3.GetRowCellValue(i, this.gridView3.Columns[SpRegisterPlace]);
							
							command.Parameters["@MaritalStatDate"].Value = Convert.ToDateTime(this.gridView3.GetRowCellValue(i, this.gridView3.Columns[DOB])).Date.ToString("yyyy-MM-dd"); //this.gridView3.GetRowCellValue(i, this.gridView3.Columns[MaritalStatusDate]);
							//======================
							//======================
							connection.Open();  
...
///Transaportation
///////////////////////
                            if (gridView3.GetRowCellValue(i, gridView3.Columns[Child1Name]).ToString().Trim() != "" && gridView3.GetRowCellValue(i, gridView3.Columns[Child1Name]).ToString().Trim().ToUpper() != "NULL")
							{
                                ...
                                try
                                {
                                    cmdEmpFamily.Parameters["@DOB"].Value = Convert.ToDateTime(gridView3.GetRowCellValue(i, gridView3.Columns[Child1DOB])).Date.ToString("yyyy-MM-dd");
                                }
                                catch
                                {
                                    cmdEmpFamily.Parameters["@DOB"].Value = DBNull.Value;
                                }
                                ...
                                try
                                {
                                    cmdEmpFamily.Parameters["@ChExemEndDate"].Value = Convert.ToDateTime(gridView3.GetRowCellValue(i, gridView3.Columns[Child1TillDate])).Date.ToString("yyyy-MM-dd");
                                }
                                catch
                                {
                            ...
                            if (gridView3.GetRowCellValue(i, gridView3.Columns[Child2Name]).ToString().Trim() != "" && gridView3.GetRowCellValue(i, gridView3.Columns[Child2Name]).ToString().Trim().ToUpper() != "NULL")
							{
								string sqlEmpID = "Select max ([ID]) from Emp ";
                                ...
                                try
                                {
                                    cmdEmpFamily.Parameters["@DOB"].Value = Convert.ToDateTime(gridView3.GetRowCellValue(i, gridView3.Columns[Child2DOB])).Date.ToString("yyyy-MM-dd");
                                }
                                catch
                                {
                                    cmdEmpFamily.Parameters["@DOB"].Value = DBNull.Value;
                                ...
                                try
                                {
                                    cmdEmpFamily.Parameters["@ChExemEndDate"].Value = Convert.ToDateTime(gridView3.GetRowCellValue(i, gridView3.Columns[Child2TillDate])).Date.ToString("yyyy-MM-dd");
                                }
                                catch
                                {
                                    cmdEmpFamily.Parameters["@ChExemEndDate"].Value = DBNull.Value;
                            ...
                            if (gridView3.GetRowCellValue(i, gridView3.Columns[Child3Name]).ToString().Trim() != "" && gridView3.GetRowCellValue(i, gridView3.Columns[Child3Name]).ToString().Trim().ToUpper() != "NULL")
							{
								string sqlEmpID = "Select max ([ID]) from Emp ";
                                ...
                                try
                                {
                                    cmdEmpFamily.Parameters["@DOB"].Value = Convert.ToDateTime(gridView3.GetRowCellValue(i, gridView3.Columns[Child3DOB])).Date.ToString("yyyy-MM-dd");
                                }
                                catch
                                {
                                    cmdEmpFamily.Parameters["@DOB"].Value = DBNull.Value;
                                ...
                                try
                                {
                                    cmdEmpFamily.Parameters["@ChExemEndDate"].Value = Convert.ToDateTime(gridView3.GetRowCellValue(i, gridView3.Columns[Child3TillDate])).Date.ToString("yyyy-MM-dd");
                                }
                                catch
                                {
                                    cmdEmpFamily.Parameters["@ChExemEndDate"].Value = DBNull.Value;
                            ...
                            if (gridView3.GetRowCellValue(i, gridView3.Columns[Child4Name]).ToString().Trim() != "" && gridView3.GetRowCellValue(i, gridView3.Columns[Child4Name]).ToString().Trim().ToUpper() != "NULL")
							{
								string sqlEmpID = "Select max ([ID]) from Emp";
                                ...
                                try
                                {
                                    cmdEmpFamily.Parameters["@DOB"].Value = Convert.ToDateTime(gridView3.GetRowCellValue(i, gridView3.Columns[Child4DOB])).Date.ToString("yyyy-MM-dd");
                                }
                                catch
                                {
                                    cmdEmpFamily.Parameters["@DOB"].Value = DBNull.Value;
                                ...
                                try
                                {
                                    cmdEmpFamily.Parameters["@ChExemEndDate"].Value = Convert.ToDateTime(gridView3.GetRowCellValue(i, gridView3.Columns[Child4TillDate])).Date.ToString("yyyy-MM-dd");
                                }
                                catch
                                {
                                    cmdEmpFamily.Parameters["@ChExemEndDate"].Value = DBNull.Value;
                            ...
                            if (gridView3.GetRowCellValue(i, gridView3.Columns[Child5Name]).ToString().Trim() != "" && gridView3.GetRowCellValue(i, gridView3.Columns[Child5Name]).ToString().Trim().ToUpper() != "NULL")
							{
								string sqlEmpID = "Select max ([ID]) from Emp ";
                                ...
                                try
                                {
                                    cmdEmpFamily.Parameters["@DOB"].Value = Convert.ToDateTime(gridView3.GetRowCellValue(i, gridView3.Columns[Child5DOB])).Date.ToString("yyyy-MM-dd");
                                }
                                catch
                                {
                                    cmdEmpFamily.Parameters["@DOB"].Value = DBNull.Value;
                                ...
                                try
                                {
                                    cmdEmpFamily.Parameters["@ChExemEndDate"].Value = Convert.ToDateTime(gridView3.GetRowCellValue(i, gridView3.Columns[Child5TillDate])).Date.ToString("yyyy-MM-dd");
                                }
                                catch
                                {
                                    cmdEmpFamily.Parameters["@ChExemEndDate"].Value = DBNull.Value;
                            ...
                            if (gridView3.GetRowCellValue(i, gridView3.Columns[TranspDesc]) != DBNull.Value && gridView3.GetRowCellValue(i, gridView3.Columns[TranspDesc]).ToString().Trim() != "" && gridView3.GetRowCellValue(i, gridView3.Columns[TransValue]) != DBNull.Value && gridView3.GetRowCellValue(i, gridView3.Columns[TransValue]).ToString().Trim().ToUpper() != "NULL" && Convert.ToDecimal(gridView3.GetRowCellValue(i, gridView3.Columns[TransValue])) != 0)
							{
								...
								if (idTr == 0)
								{
                                    ...
                                    if (gridView3.GetRowCellValue(i, gridView3.Columns[TranspDesc]).ToString().Length > 50)
                                    {
                                        cmdPayItems.Parameters["@ItmDesc"].Value = gridView3.GetRowCellValue(i, gridView3.Columns[TranspDesc]).ToString().Substring(0, 50);
                                    }
                                    else
                                    {
                                        cmdPayItems.Parameters["@ItmDesc"].Value = gridView3.GetRowCellValue(i, gridView3.Columns[TranspDesc]).ToString();
                                    }
                                    if (gridView3.GetRowCellValue(i, gridView3.Columns[TranspCode]).ToString().Length > 8)
                                    {
                                        cmdPayItems.Parameters["@ItmAbb"].Value = gridView3.GetRowCellValue(i, gridView3.Columns[TranspCode]).ToString().Substring(0, 8);
                                    }
                                    else
                                    {
                            ...
                            //}
                            ////======================
                            //if (gridView3.GetRowCellValue(i, gridView3.Columns[IncomePayItemValue3]) != DBNull.Value && gridView3.GetRowCellValue(i, gridView3.Columns[IncomePayItemValue3]).ToString().Trim() != "")
                            //{
                            //    string sqlPI3 = "Select max ([ID]) from Emp";
                            //    SqlCommand cmdPI3 = new SqlCommand(sqlPI3, connection);
                            //    connection.Open();
                            //    int idemPI3 = Convert.ToInt32(cmdPI3.ExecuteScalar());

                            //    cmdPayItem3.Parameters["@emID3"].Value = idemPI3;
                            //    cmdPayItem3.Parameters["@piValue3"].Value = gridView3.GetRowCellValue(i, gridView3.Columns[IncomePayItemValue3]);

                            //    cmdPayItem3.ExecuteNonQuery();
                            //    connection.Close();
                            //}
                            ////======================
                            //if (gridView3.GetRowCellValue(i, gridView3.Columns[IncomePayItemValue4]) != DBNull.Value && gridView3.GetRowCellValue(i, gridView3.Columns[IncomePayItemValue4]).ToString().Trim() != "")
                            //{
                            //    string sqlPI4 = "Select max ([ID]) from Emp";
                            //    SqlCommand cmdPI4 = new SqlCommand(sqlPI4, connection);
                            //    connection.Open();
                            //    int idemPI4 = Convert.ToInt32(cmdPI4.ExecuteScalar());

                            //    cmdPayItem4.Parameters["@emID4"].Value = idemPI4;
                            //    cmdPayItem4.Parameters["@piValue4"].Value = gridView3.GetRowCellValue(i, gridView3.Columns[IncomePayItemValue4]);

                            //    cmdPayItem4.ExecuteNonQuery();
                            //    connection.Close();
                            //}
                            //======================
